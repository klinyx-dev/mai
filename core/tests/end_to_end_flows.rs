...
use mai::{
    ActorId, AddAppointmentCommand, AddSlotCommand, AppointmentId, CancelAppointmentCommand,
    CancelSlotCommand, SchedulerError, SchedulerService, SlotId, WeeklyLayoutQuery,
};
